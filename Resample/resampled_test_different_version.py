...
img_task1 = nib.load(r'D:\ICT\Thesis\Data\Task1\RSNA_ASNR_MICCAI_BraTS2021_TrainingData_16July2021\BraTS2021_00480\BraTS2021_00480_t1.nii.gz')
img_task2_sitk = sitk.ReadImage(r'D:\ICT\Thesis\Data\rsna-miccai-brain-tumor-radiogenomic-classification\train_nifti\00480\T1w\00480T1w.nii')
img_task2_nib = nib.load(r'D:\ICT\Thesis\Data\rsna-miccai-brain-tumor-radiogenomic-classification\train_nifti\00480\T1w\00480T1w.nii')

# output directory to save the comparison result 
out_path = r'D:\ICT\Thesis\Github\repo\Resample\00480T1w.jpg'
